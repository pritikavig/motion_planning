...
public class MotionPlannerDriver extends Application {
    ...
    private static final double RESOLUTION = 0.1;  // resolution for interpolation
    ...
    public void start(Stage primaryStage) {
        initMPView(primaryStage, ENVIRONMENT, ROBOT);
     ...
     */
    private void initMPView(Stage primaryStage, Environment environment, Robot robot) {
        mpView = new MotionPlannerView(primaryStage, environment, robot);
    }
